      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="text-xl font-extrabold tracking-tight text-foreground inline-block"
            >
              Jake Avard
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="p-2 rounded-full bg-muted hover:bg-forest-100 dark:hover:bg-forest-900 text-muted-foreground hover:text-forest-700 dark:hover:text-forest-300 transition-colors"
                aria-label="Twitter"
              >
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-muted-foreground hover:text-forest-700 dark:hover:text-forest-300 transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
