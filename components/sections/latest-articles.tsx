      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col gap-4 rounded-2xl border border-border p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white"
          >
            <div className="aspect-[16/10] rounded-xl overflow-hidden bg-neutral-100">
              <img
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-foreground group-hover:text-forest-800 transition-colors">
              ...
              <div className="flex items-center gap-2 text-sm font-semibold text-forest-800 pt-2">
