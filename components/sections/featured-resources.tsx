        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {resources.map((resource) => (
            <Link
              key={resource.id}
              href={resource.url}
              className="group relative flex flex-col rounded-2xl bg-white border border-border p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <h3 className="text-xl font-bold text-foreground mb-2 group-hover:text-forest-800 transition-colors">
                {resource.title}
              </h3>
