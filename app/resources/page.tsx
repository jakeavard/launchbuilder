...
import { resources, resourceCategories } from '@/lib/data/content';
    ...
    <>
      ...
      {resourceCategories.map((category) => {
        ...
        return (
          <section
            key={category}
            className="py-16 md:py-20 border-t border-border bg-white dark:bg-background"
          >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-forest-50 dark:bg-forest-950 text-forest-700 dark:text-forest-400">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {categoryResources.map((resource) => (
                  <div
                    key={resource.id}
                    className="group flex flex-col rounded-2xl border border-border p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-background"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-forest-50 dark:bg-forest-950 text-forest-700 dark:text-forest-400">
                    ...
                    <div className="mt-6">
                      <Link
                        href={resource.url}
                        className="inline-flex items-center gap-2 text-sm font-semibold text-forest-800 dark:text-forest-400 hover:underline underline-offset-4"
                      >
