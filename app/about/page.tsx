...
import { BookOpen, Hammer, Mic, Mountain } from 'lucide-react';
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl bg-neutral-50 p-6 text-center">
                  <p className="text-3xl font-extrabold text-forest-800">6</p>
                  <p className="text-sm text-muted-foreground mt-1">Years in Mission</p>
                </div>
                <div className="rounded-xl bg-neutral-50 p-6 text-center">
                  <p className="text-3xl font-extrabold text-forest-800">2</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {pillars.map((pillar) => (
              <div
                key={pillar.title}
                className="group rounded-2xl bg-white border border-border p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
