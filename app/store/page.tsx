...
export default function StorePage() {
  return (
    <>
      ...
      {/* Coming Soon */}
      <section className="py-16 md:py-20 bg-white dark:bg-background border-t border-border">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <ShoppingBag className="h-10 w-10 text-forest-700 dark:text-forest-400 mx-auto mb-4" />
