    ...
    <div className="tither-widget-container py-16 flex justify-center bg-neutral-50 border-t border-border"> 
      ...
      */}
      <a
        ...
        className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white rounded-full bg-[#183c8d] hover:bg-[#6d28d9] transition-all duration-200 hover:scale-[1.02] shadow-sm"
      >
        Give Now
      </a>
    </div>
